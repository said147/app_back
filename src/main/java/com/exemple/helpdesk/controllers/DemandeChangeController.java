...
public class DemandeChangeController {
   ...
   /* @RequestMapping( value="/demanders/{id_demande}",method= RequestMethod.GET)
    ...
    @RequestMapping(value = "/demaneChange/{id_demandeChange}",method =RequestMethod.GET )
    public Optional<DemandeChange> getProductsByNa(@PathVariable Long id_demandeChange) {


        return  demandeChangeRepository.findById(id_demandeChange);
